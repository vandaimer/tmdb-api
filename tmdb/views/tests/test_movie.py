...
class TestMovie:
    def test_get_upcoming_list_with_errors(self, mocker):
        mocker.patch('tmdb.services.tmdb.TMDBService.get_upcoming_movie_list',
                     return_value={'errors': 'Error'})
    ...
    def test_get_upcoming_list_without_errors(self, mocker):
        ...
        mocker.patch('tmdb.views.movie.Movie.build_movie',
    ...
    def test_build_movie_with_all_attr(self, mocker):
        ...
        mocker.patch('tmdb.views.genre.Genre.get_genre_by_id',
                     side_effect=lambda x: genres[x])
        mocker.patch('tmdb.services.tmdb.TMDBService.get_image_url',
                     side_effect=lambda x: x)
        poster = 'poster'
        backdrop = 'backdrop'
